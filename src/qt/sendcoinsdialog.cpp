...

{
    ...
    ui->sendButton->setIcon(QIcon());
     ...
     ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a TheGCCcoin address (e.g. SGVQhkwomS9tEDhwakwZC9aVqFtzEF1ZVG)"));
#endif
...
void SendCoinsDialog::customizeUI()
{
    ...
    ui->frameCoinControl->setStyleSheet(SC_QSS_TOOLTIP_DEFAULT + " QFrame {background-color: " + QString(SC_MAIN_COLOR_SEND) + "; color: white; font-size: 15px; border: none;}");
    ui->widgetCoinControl->setStyleSheet(SC_QSS_TOOLTIP_DEFAULT + " QLabel {background-color: " + QString(SC_MAIN_COLOR_SEND) + "; color: white; font-size: 12px; border: none;}");
    ...
    ui->frmBalance->setStyleSheet("QFrame {background-color: #ffffff; color: #000000;}");
    ...
    qss = SC_QSS_TOOLTIP_DEFAULT + "QPushButton {background-image: url(";
    qss += SC_BTN_PATH_ACTIVE;
    qss += "bg_send_thegcccoin.png); background-repeat: no-repeat; background-position: center; border: none;}";
    qss += "QPushButton::hover {background-image: url(";
    qss += SC_BTN_PATH_DEFAULT;
    qss += "bg_send_thegcccoin.png);}";
    ...
    qss += "QScrollBar::handle:vertical { background-color: #00c6ff; min-height:  40px;}";
    qss += "QScrollBar::sub-page:vertical { background-color: #fff; }";
    qss += "QScrollBar::add-page:vertical { background-color: #fff; }";
    ui->scrollArea->setStyleSheet(qss);

    ui->scrollAreaWidgetContents->setObjectName("scroll-area-widget");
    ui->scrollAreaWidgetContents->setStyleSheet("QWidget#scroll-area-widget {background-color: #ffffff; border: none;}");

    qss = "SendCoinsDialog {border: none; background-color: #ffffff;}";
