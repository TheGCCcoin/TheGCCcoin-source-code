    ...
    tab(tab)
{
    ...
    QString toolTipString[6] = {
        ...
        "Show QR code",
        "Sign a message to prove you own a TheGCCcoin address",
        "Verify a message to ensure it was signed with a specified TheGCCcoin address",
...
void QPageAddrBook::createHeader()
{
    ...
    QString slQss[2] = {
        QString() + "background-color: #ffffff; font-size: 13px; padding: 0px 10px; color: #000000;",
        QString() + "background-color: #ffffff; font-size: 13px; padding: 0px 10px; color: #000000;"
    };
