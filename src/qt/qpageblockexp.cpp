    ...
    QStealthPage(parent)
{
    ...
    lblBottom->setStyleSheet("background-color: #fff;");
    ...
    btnJump->setFrontStyleSheet(
        "background-color: #fff" + QString(SC_MAIN_COLOR_WHITE) + "; color: black;",
