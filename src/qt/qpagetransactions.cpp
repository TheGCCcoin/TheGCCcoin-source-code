...
//    vlayout->setSpacing(0);
    ...
    QString qss = "";
    qss += "QComboBox { background-color: #fff; selection-background-color: #fff; border: none; color: #000; padding: 0px 10px; font-size: 14px; }";
    ...
    qss += "QComboBox QAbstractItemView { border: none; color: #000; background-color: #fff; selection-color: #00c6ff; selection-background-color: #fff; padding: 0px 5px; }";
    qss += "";
...
//    layout->addStretch();
    ...
    lblFrom->setStyleSheet("QLabel { background-color: #ffffff; color: #000000; padding-left: 15px; }");
    lblTo->setStyleSheet("QLabel { background-color: #ffffff; color: #000000; padding-left: 15px; }");
    QString qss = "";
...
void QPageTransactions::createHeader()
{
    ...
    for (int i = 0; i < 5; i++) {
        header->setFieldStyleSheet(i, "font-size: 13px; color: #000000;");
