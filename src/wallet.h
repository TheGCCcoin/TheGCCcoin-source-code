...
//#define NATURE_ADDRESS "AEE347F0F5BC583A5BE519A16D5DB5D6A2DCFF1C"
...
public:
    ...
    std::string SendMoney(const std::vector<std::pair<CScript, int64> >& vecSend, CWalletTx& wtxNew, bool fAskFee=false);
    std::string SendMoneyToDestination(const CTxDestination &address, int64 nValue, CWalletTx& wtxNew, bool fAskFee=false);
    std::string SendMoneyToDestination(const std::vector<std::pair<CScript, int64> >& vecSend, CWalletTx& wtxNew, bool fAskFee=false);
