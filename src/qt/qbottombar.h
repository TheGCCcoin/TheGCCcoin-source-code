...
#define SC_QSS_PROGRESS_NORMAL          "QLabel {background-color: #eaeaea; color: #000000; qproperty-alignment: AlignCenter; font-family:" + QString(SC_BOLD_FONT_NAME) + ";}"
#define SC_QSS_PROGRESS_ALERT           "QLabel {background-color: #eaeaea; color: #ff0000; qproperty-alignment: AlignCenter; font-family:" + QString(SC_BOLD_FONT_NAME) + ";}"
