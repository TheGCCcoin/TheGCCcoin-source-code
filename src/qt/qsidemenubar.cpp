...
#define SC_SIDE_BTN_WIDTH               243
#define SC_SIDE_BTN_HEIGHT              50

#define SC_COLOR_MAIN_BACKGROUND        "#eaeaea"
    ...
    QLabel(parent)
{
    ...
    for (int i = 0; i < SC_SIDE_BUTTON_COUNT; i++) {
        ...
        btn[i]->setGeometry(6, top, SC_SIDE_BTN_WIDTH, SC_SIDE_BTN_HEIGHT);
