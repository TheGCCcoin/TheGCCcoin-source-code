    ...
    QLabel(parent)
{
    ...
    setStyleSheet("background-color: " + QString(SC_MAIN_COLOR_WHITE) + ";");
}
    ...
    fShowHeader(true)
{
    ...
    lblBack->setStyleSheet("QLabel {background-color: #ffffff; border: none;}");
    ...
    qss = "";
    qss += "QScrollBar::handle:vertical{background-color: #eaeaea; min-height:40px;}";
    qss += "QScrollBar::add-page:vertical, QScrollBar::sub-page:vertical{background-color: #00c6ff;}";
    this->verticalScrollBar()->setStyleSheet(qss);

    this->lblBack->setStyleSheet("QLineEdit {background-color: white; border: 1px solid #00c6ff;}");
#else
    qss = "QStealthTableView {border: none; background-color: #ffffff;}";
    this->setStyleSheet(qss);

    qss = "";
    qss += "QScrollBar::handle:vertical{background-color: #ffff; min-height:40px;}";
    qss += "QScrollBar::add-page:vertical, QScrollBar::sub-page:vertical{background-color: #00c6ff;}";
    this->verticalScrollBar()->setStyleSheet(qss);
#endif
}
