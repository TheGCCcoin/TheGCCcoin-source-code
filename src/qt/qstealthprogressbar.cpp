    ...
    QLabel(parent)
{
    ...
    QString qss = "QProgressBar { border: 0px solid #grey; border-radius: 5px; background-color: #00c6ff}";
    qss += "QProgressBar::chunk { background-color: " + QString(SC_MAIN_COLOR_BLUE2) + "; border-radius: 5px; }";
...
void QStealthProgressBar::setPercent(int percent)
{
    ...
    QString qss = "color:" + QString(SC_MAIN_COLOR_BLACK) +
                  "; font-family: black";
