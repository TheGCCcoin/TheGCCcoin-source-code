...
#define SC_QSS_TOOLTIP_DEFAULT          tr("QToolTip {color: #1b1b1b; background-color: #fff; border: 0px; font-size: 10px; padding-top: 3px;}")

// Windsong: for testing
// #define SC_APP_FONT_PATH                ":/resources/res/fonts/Windsong/Windsong.ttf"
// #define SC_APP_FONT_NAME                "Windsong"
#define SC_APP_FONT_PATH                ":/resources/res/fonts/Roboto/Roboto-Regular.ttf"
#define SC_APP_FONT_NAME                "Open Sans"
#define SC_BOLD_FONT_PATH               ":/resources/res/fonts/Roboto/Roboto-Regular.ttf"
...
#define SC_MAIN_COLOR_BLUE              "#000000"
#define SC_MAIN_COLOR_TITLE             "#3cabe1"
#define SC_MAIN_COLOR_SEND              "#3cabe1"
#define SC_MAIN_COLOR_SEND2              "#eaeaea"
#define SC_MAIN_COLOR_WHITE             "#fff"
#define SC_MAIN_COLOR_BLACK             "#000"
#define SC_MAIN_COLOR_GREY              "#aeafb1"
#define SC_MAIN_COLOR_BLUE2             "#00c6ff"
...
#define SC_ICON_PATH_BIGGER_HOVER       ":/resources/res/images/icons-big-hover/"
